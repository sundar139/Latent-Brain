...
def build_neural_ode_refinement_result_row(
    run_id: str,
    run_index: int,
    params: dict[str, Any],
    ...
    row.update(
        {
            ...
            > float(references["previous_switching_ode_validation_bits_per_spike"]),
...
def rank_neural_ode_refinement_results(
...
def summarize_neural_ode_refinement(
    results: pd.DataFrame,
    references: dict[str, float],
) -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {
        ...
        "previous_switching_ode_reference": float(
            references["previous_switching_ode_validation_bits_per_spike"]
        ),
    ...
    return summary | {
        ...
        "best_learning_rate": float(best_result.get("learning_rate", float("nan"))),
        "final_learning_rate": float(best_result.get("final_learning_rate", float("nan"))),
