...
def build_lfads_unified_result_row(
    run_id: str,
    run_index: int,
    params: dict[str, Any],
...
def rank_lfads_unified_results(
    ...
    ranked = completed.sort_values(
        [metric, "validation_poisson_nll", "validation_behavior_mean_r2", "kl_scale", "run_index"],
...
def summarize_lfads_unified_tuning(
    results: pd.DataFrame,
    references: dict[str, float],
) -> dict[str, Any]:
